...
import pygame
import time
import math   #: For users use/ I.e if they want to exec features from time or math
import sys
...
def displaylines(surface, text, font, color, pos):
    ...
    for i, words in enumerate(multi_text):
        ...
        number_line = font.render(num, True, (100, 200, 10))
        surface.blit(text_surface, (x, (y + (i*h))))
        surface.blit(number_line, (x - 30, (y + i*h)))
